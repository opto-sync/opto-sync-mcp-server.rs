# AGENTS.md — opto-sync/opto-sync-mcp-server.rs
...
- GitHub org: [`opto-sync`](https://github.com/opto-sync)
- Repository: [`opto-sync/opto-sync-mcp-server.rs`](https://github.com/opto-sync/opto-sync-mcp-server.rs)
- Local checkout: `~/codes/opto-sync/opto-sync-mcp-server.rs`
- Linear project: https://linear.app/denman/project/githubcomopto-sync-de6ba65bd559
- GitHub org project: https://github.com/orgs/opto-sync/projects/1
- Sibling test org: `github.com/opto-sync-test` (external/e2e coverage and extra GHA minutes)
- Slack workspace: oresoftware-workspace.slack.com
- Kind: product MCP server for this GitHub org
- Package / service name: `opto-sync-mcp-server`
